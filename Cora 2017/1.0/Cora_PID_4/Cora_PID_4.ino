...
void leitura_sensores() {
  ...
  /* else if ((ses[0] == 0 && ses[1] == 0 && ses[2] == 0 && ses[3] == 0 && ses[4] == 1 && ses[5] == 0 && ses[6] == 0 && ses[7] == 0 && ses[8] == 0)||
            (ses[0] == 0 && ses[1] == 0 && ses[2] == 0 && ses[3] == 1 && ses[4] == 1 && ses[5] == 0 && ses[6] == 0 && ses[7] == 0 && ses[8] == 0)||
            (ses[0] == 0 && ses[1] == 0 && ses[2] == 0 && ses[3] == 1 && ses[4] == 1 && ses[5] == 1 && ses[6] == 0 && ses[7] == 0 && ses[8] == 0)||
            (ses[0] == 0 && ses[1] == 0 && ses[2] == 0 && ses[3] == 0 && ses[4] == 1 && ses[5] == 1 && ses[6] == 0 && ses[7] == 0 && ses[8] == 0)){acao = marcador2;} */
